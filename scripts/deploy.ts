...
import { HelloWorldBsvContract } from '../src/contracts/helloWorldBsvContract'
...
async function main() {
    await HelloWorldBsvContract.loadArtifact()
    ...
    const instance = new HelloWorldBsvContract(
    ...
    console.log('HelloWorldBsvContract contract was successfully deployed!')
